...
if (isset($_POST['detak_jantung']) && isset($_POST['kadar_oksigen'])) {
    ...
    $sql = "INSERT INTO tbjantung (`Detak Jantung (BPM)`, `Kadar Oksigen (%)`) VALUES ('$detak_jantung', '$kadar_oksigen')";
...
$sql = "SELECT * FROM tbjantung ORDER BY datetime ASC";
...
if ($result && mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        $detak_jantung_data[] = $row['Detak Jantung (BPM)'];
